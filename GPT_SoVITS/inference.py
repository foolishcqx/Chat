...
if __name__ == "__main__":
    sr, wav = get_tts_wav(
        ref_wav_path=r"D:\lasetTTS\code\keli\chatting-harvest.ogg",
        prompt_text="可莉今天又勇敢地抓到了花纹奇怪的蜥蜴！从没见过这种图案，你要看看吗？",
        text="今天天气真好！",
        text_language="中文",
    )
    # 把生成的音频保存到本地
    write("gpt_output.wav", sr, wav)
    print("已生成 output.wav，可直接播放！")